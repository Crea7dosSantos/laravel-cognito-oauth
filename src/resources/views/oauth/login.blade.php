...
@section('description', '')
@section('keywords', '')
@section('additionalJsLibsDefer', 'https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.js')
                        ...
                        <form class="mt-8" id='form' action="{{ route('login') }}" method="post">
                            ...
                            <div class="mx-auto max-w-lg">
                                <div class="py-2">
                                    ...
                                    <input placeholder="" name="email" type="text" class="text-md block px-3 py-2  rounded-lg w-full 
